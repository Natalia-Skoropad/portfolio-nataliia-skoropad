...
export const PROJECTS: Project[] = [
  // ===== Frontend =====
  {
    ...
    stack: [
      ...
      { label: 'Formik', iconId: 'icon-formik-small-logo-gold' },
  ...
  },
  {
    id: 'easy-notes',
    title: 'EasyNotes',
    image: '/images/work/frontend/easy-notes-mobile.jpg',
    image2x: '/images/work/frontend/easy-notes-mobile@2x.jpg',
    imageTab: '/images/work/frontend/easy-notes-tab.jpg',
    imageTab2x: '/images/work/frontend/easy-notes-tab@2x.jpg',
    imageDesk: '/images/work/frontend/easy-notes-desk.jpg',
    imageDesk2x: '/images/work/frontend/easy-notes-desk@2x.jpg',
    imageBlur: '',
    alt: 'EasyNotes',
    href: 'https://easy-notes-ten.vercel.app/',
    categories: ['frontend'],
    stack: [
      { label: 'React', iconId: 'icon-react-small-logo-gold' },
      { label: 'TS', iconId: 'icon-typescript-small-logo-gold' },
      ...
      { label: 'CSS', iconId: 'icon-css-logo-gold' },
      { label: 'HTML', iconId: 'icon-html-logo-gold' },
      { label: 'Nextjs', iconId: 'icon-nextjs-small-logo-gold' },
